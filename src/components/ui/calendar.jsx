...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-background w-full px-4 py-2 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(7)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      classNames={{
        ...
        day: cn(
          "group/day relative aspect-square h-full w-full rounded-(--cell-radius) p-0 text-center flex items-center justify-center select-none [&:last-child[data-selected=true]_button]:rounded-r-(--cell-radius)",
